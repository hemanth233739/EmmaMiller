...
from EmmaMiller import telethn as bot
from EmmaMiller.modules.urluploader import download_file
from EmmaMiller.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @BotMasterOfficial",
            )
        except Exception as e:
            traceback.print_exc()
