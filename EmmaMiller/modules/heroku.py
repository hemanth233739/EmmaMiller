...
from EmmaMiller import telethn as borg, HEROKU_APP_NAME, HEROKU_API_KEY, OWNER_ID
from EmmaMiller.events import register
from EmmaMiller.function.heroku_helper import HerokuHelper
...
async def restart_bot(dyno):
    ...
    args = [sys.executable, "-m", "EmmaMiller"]
